...
Zdrojová data pocházejí z výsledků mužského okruhu ATP Tour za období 2005–2025 (zdroj: veřejně dostupný dataset ATP zápasů (2005–2025), stažený z Kaggle.com. (výsledky finále jednotlivých turnajů), doplněná o referenční přehled počtu turnajů v jednotlivých letech (zdroj: tenisportal.cz/kalendar/atp) a ručně sestavenou tabulku zemí. Do modelu byly načteny čtyři samostatné zdrojové tabulky:
